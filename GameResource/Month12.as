package GameResource {
	...
	public class Month12 extends MovieChangePhotoAndObjectPropertyModify {
		
		private const intPhotoWidth:int = 640;
		private const intPhotoHeight:int = 960;
		
		public function Month12(photoBitmapIn:Bitmap = null, isSoundEnableIn:Boolean = true, isPlayOnAddedIn:Boolean = false) {
			// constructor code
			...
			if (photoBitmap) {
				setBitmap();
				stageMovie = new Month12GameMovie();
