package GameResource {
	...
	import tw.cameo.game.ChosePicturePannelIOSAneAndroidDefaultCameraRollAndCameraUI;
	...
	public class GameType2Flow extends MovieClip {
		...
		private var chosePicturePannel:ChosePicturePannelIOSAneAndroidDefaultCameraRollAndCameraUI = null;
...
//				chosePicture();
		...
		private function chosePicture() {
			chosePicturePannel = new ChosePicturePannelIOSAneAndroidDefaultCameraRollAndCameraUI("請從相簿挑選或拍攝照片。");
			chosePicturePannel.addEventListener(ChosePicturePannelIOSAneAndroidDefaultCameraRollAndCameraUI.PICTURE_LOADED, onPictureLoaded);
			_container.addChild(chosePicturePannel);
		}
		
		private function removeChosePicturePannel() {
			if (chosePicturePannel) {
				chosePicturePannel.removeEventListener(ChosePicturePannelIOSAneAndroidDefaultCameraRollAndCameraUI.PICTURE_LOADED, onPictureLoaded);
