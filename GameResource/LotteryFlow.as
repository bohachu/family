package GameResource {
	...
	public class LotteryFlow extends MovieClip {
		...
		private function playResult() {
			resultAnimation = (strResult == "WIN") ? new LotteryAnimationWin() : new LotteryAnimationLose();
