package GameResource {
	...
	public class Month5 extends MovieChangePhotoAndObjectPropertyModify {
		
		private const intPhotoWidth:int = 640;
		private const intPhotoHeight:int = 960;
		
		public function Month5(photoBitmapIn:Bitmap = null, isSoundEnableIn:Boolean = true, isPlayOnAddedIn:Boolean = false) {
			// constructor code
			...
			if (photoBitmap) {
				setBitmap();
				stageMovie = new Month5GameMovie();
